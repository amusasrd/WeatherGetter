...
//  iWeather
//
//  Created by Ahmed Musa on 12/1/17.
//  Copyright © 2017 Moses Apps. All rights reserved.
//
...
struct Weather {
    ...
    //open weather reports temperature in Kelvin, which is why we provide celsius and fahrenheit computed properties.
    ...
    //these properties are optional because openweathermap doesn't provide a value for wind direction when the wind speed is negligible, or rain when there is no rainfall.
